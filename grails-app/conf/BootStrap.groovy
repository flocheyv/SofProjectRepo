...
class BootStrap {
    ...
    def init = { servletContext ->
		...
		def testUser = new User(username: 'UserX', enabled: true, password: 'password', website: 'www.lol.fr', location: 'Clermont-Ferrand', age: 40, reputation: 2)
						.addToBadges(noob)
		def testUser1 = new User(username: 'User1', enabled: true, password: 'password', website: 'www.lol.fr', location: 'Clermont-Ferrand', age: 40, reputation: 3)
						.addToBadges(noob)
		def testUser2 = new User(username: 'User2', enabled: true, password: 'password', website: 'www.lol.fr', location: 'Clermont-Ferrand', age: 40, reputation: 4)
						.addToBadges(noob)
		def testUser3 = new User(username: 'User3', enabled: true, password: 'password', website: 'www.lol.fr', location: 'Clermont-Ferrand', age: 40, reputation: 5)
						.addToBadges(noob)
		def testUser4 = new User(username: 'User4', enabled: true, password: 'password', website: 'www.lol.fr', location: 'Clermont-Ferrand', age: 40, reputation: 6)
						.addToBadges(noob)
		def testUser5 = new User(username: 'User5', enabled: true, password: 'password', website: 'www.lol.fr', location: 'Clermont-Ferrand', age: 40, reputation: 7)
						.addToBadges(noob)
